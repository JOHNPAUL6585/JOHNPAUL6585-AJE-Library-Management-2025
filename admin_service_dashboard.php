...
td, a{
    color:black;
        ...
        body {
            font-family: 'Roboto';
            background-image: url('images/Lib_BI.png');
    ...
    ?>
        ...
        <div class="innerdiv">
            ...
            <div class="leftinnerdiv">
                ...
                <br>
                <Button class="greenbtn" onclick="openpart('addbook')" ><img class="icons" src="images/icon/addbook.png" width="30px" height="30px"/>  ADD BOOK</Button>
                <Button class="greenbtn" onclick="openpart('bookreport')" > <img class="icons" src="images/icon/bookreport.png" width="30px" height="30px"/> INVENTORY</Button>
                <Button class="greenbtn" onclick="openpart('bookrequestapprove')"><img class="icons" src="images/icon/bookrequest.png" width="30px" height="30px"/> BOOK REQUESTS</Button>
                <Button class="greenbtn" onclick="openpart('addperson')"> <img class="icons" src="images/icon/adduser.png" width="30px" height="30px"/> ADD STUDENT</Button>
                <Button class="greenbtn" onclick="openpart('studentrecord')"> <img class="icons" src="images/icon/userreport.png" width="30px" height="30px"/> STUDENTS LOG</Button>
                <Button class="greenbtn"  onclick="openpart('issuebook')"> <img class="icons" src="images/icon/issuebook.png" width="30px" height="30px"/> LOAN BOOK</Button>
                <Button class="greenbtn" onclick="openpart('issuebookreport')"> <img class="icons" src="images/icon/issuereport.png" width="30px" height="30px"/> BOOK LOAN LOG</Button>
                <a href="index.php"><Button class="greenbtn" ><img class="icons" src="images/icon/logout1.png" width="30px" height="30px"/> LOGOUT</Button></a>
            </div>

            <div class="rightinnerdiv">   
            <div id="bookrequestapprove" class="innerright portion" style="display:none">
            <Button class="greenbtn" >APPROVE BOOK REQUEST</Button>
            ...
            <label>Publication Year</label><input type="text" name="bookpub"/></br>
            <div><label>Genre:</label><input type="radio" name="branch" value="other"/>INSPIRATION<input type="radio" name="branch" value="BSIT"/>IT<div style="margin-left:80px"><input type="radio" name="branch" value="other"/>GEOGRAPHY<input type="radio" name="branch" value="BSCS"/>MEDICINE<input type="radio" name="branch" value="BSSE"/>EDUCATION</div>
            </div>   
            ...
            <label>Full Name:</label><input type="text" name="addname"/>
            </br>
            <label>Password:</label><input type="pasword" name="addpass"/>
            </br>
            <label>Email Address:</label><input  type="email" name="addemail"/></br>
            <label for="typw">Select Role:</label>
            <select name="type" >
            ...
            <Button class="greenbtn" >ISSUE BOOK LOG</Button>
