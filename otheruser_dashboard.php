...
<html>
    ...
    <style>
        body {
    background-image: url('images/20250401_151141.jpg');
    ...
    ?>
           <div class="container">
            ...
            <div class="leftinnerdiv">
                <br>
                <Button class="greenbtn" onclick="openpart('myaccount')"> <img class="icons" src="images/icon/profiler.png" width="30px" height="30px"/>  My Profile</Button>
                <Button class="greenbtn" onclick="openpart('requestbook')"><img class="icons" src="images/icon/bookrequest.png" width="30px" height="30px"/> Book Loan</Button>
                <Button class="greenbtn" onclick="openpart('issuereport')"> <img class="icons" src="images/icon/bookreport.png" width="30px" height="30px"/>  Book Loan Log</Button>                
            ...
            <Button class="greenbtn" >My Dashboard</Button>
            ...
            <p style="color:black"><u>Full Name:</u> &nbsp&nbsp<?php echo $name ?></p>
            <p style="color:black"><u>Email Address:</u> &nbsp&nbsp<?php echo $email ?></p>
            <p style="color:black"><u>Role:</u> &nbsp&nbsp<?php echo $type ?></p>
            ...
            <Button class="greenbtn" >BOOK HISTORY</Button>
